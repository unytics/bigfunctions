---
title: "explore_events"
description: "BigFunction explore_events: Show events (WORK IN PROGRESS)"
---

<span>style="color: gray; position: relative; top: -1rem"><a href="..">BigFunctions </a> / explore_events</span>
...
=== "EU"
    ...
    ```sql
    call bigfunctions.eu.explore_events("eu.natality.weight_pounds");
...
=== "US"
    ...
    ```sql
    call bigfunctions.us.explore_events("us.natality.weight_pounds");
    select html from bigfunction_result;
    ```
...
=== "europe-west1"
    ...
    ```sql
    call bigfunctions.europe_west1.explore_events("europe_west1.natality.weight_pounds");
    select html from bigfunction_result;
    ```
